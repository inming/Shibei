...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 8,
        sql: include_str!("../migrations/008_questions.sql"),
    },
    Migration {
        version: 9,
        sql: include_str!("../migrations/009_question_index.sql"),
    },
    Migration {
        version: 10,
        sql: include_str!("../migrations/010_content_time.sql"),
    },
    Migration {
        version: 11,
        sql: include_str!("../migrations/011_question_notes.sql"),
    },
    Migration {
        version: 12,
        sql: include_str!("../migrations/012_question_index_notes.sql"),
    },
];
