...
- **同步日志**：所有 CRUD 函数接受 `Option<&SyncContext>` 参数，操作后追加 sync_log 记录；测试中传 `None` 跳过
...
- 当前 npm 依赖：react, react-dom, @tauri-apps/api, react-markdown, remark-gfm, vite, typescript, vitest, @testing-library/react
